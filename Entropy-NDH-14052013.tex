...
entropy rate of the stationary Markov chain. We find that the entropy rate of
...
in the graph based approach.This is described in the results section
...
$\delta$ such that transforms into $G^{\delta}$
\begin{equation}
