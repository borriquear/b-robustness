...
if isfield(tmp.EC.edg,'opacity_same')
    EC.edg.opacity = tmp.EC.edg.opacity_same;
end
if isfield(tmp.EC.edg,'opacity_max')
    EC.edg.opacity = tmp.EC.edg.opacity_max;
end
if isfield(tmp.EC.edg,'opacity_min')
    EC.edg.opacity = tmp.EC.edg.opacity_min;
end
if isfield(tmp.EC.edg,'opacity_abs')
    EC.edg.opacity = tmp.EC.edg.opacity_abs;
end
