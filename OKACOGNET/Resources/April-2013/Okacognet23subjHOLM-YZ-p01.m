...
%glob_n_vul =0.0250 (quite robust network , because young subjects?
%Check with older ones?)
...
[B,IX]=sort(node_vul)
[B_e,IX_e]=sort(node_vul)
%Write results in Ecxcel
xlswrite('/Users/jagomez/Eclipse/workspace/OKACOGNET/Resources/MatLabLib/FinaleRZ23-B-Young-HOLM-YL.xls',B_e', 'Elder','C2:C91')
xlswrite('/Users/jagomez/Eclipse/workspace/OKACOGNET/Resources/MatLabLib/FinaleRZ23-I-Young-HOLM-YL.xls', IX_e','Elder','A2:A91')
